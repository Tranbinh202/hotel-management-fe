...
import { CalendarIcon, ChevronLeft, ChevronRight, Loader2, Hotel, User, CreditCard, CheckCircle2 } from "lucide-react"
...
export default function BookingPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await bookingsApi.createByGuest(bookingData)

      if (response.isSuccess) {
        router.push(`/booking/success?bookingCode=${response.data.bookingCode}`)
      } else {
                ...
                {checkInDate && checkOutDate ? (
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t flex justify-between items-center">
                      <span className="font-serif text-lg font-semibold">Tổng cộng:</span>
