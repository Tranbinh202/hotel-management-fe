...
export default function Home() {
  ...
  useEffect(() => {
    const fetchRooms = async () => {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/room-types`)
        if (response.ok) {
      ...
      <section id="rooms" className="py-32 bg-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <h2 className="font-serif text-5xl md:text-6xl font-bold mb-6 py-4 luxury-text-gradient">Phòng nghỉ cao cấp</h2>
              ...
              ? rooms.map((room, index) => (
                  ...
                  >
                    <div className="relative h-72 overflow-hidden">
                      <Image
                        src={room.images?.[0] || "/hotel-building-exterior-modern-architecture.jpg"}
                        alt={room.name}
                        width={600}
                        height={400}
      ...
      <section id="amenities" className="py-32 bg-muted">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="font-serif text-5xl md:text-6xl font-bold mb-6 py-4 luxury-text-gradient">Tiện nghi đẳng cấp</h2>
            <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-loose">
      ...
      <section id="offers" className="py-32 bg-gradient-to-br from-[oklch(0.99_0.005_85)] to-[oklch(0.96_0.01_85)]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="font-serif text-5xl md:text-6xl font-bold mb-6 py-4 luxury-text-gradient">Ưu đãi đặc biệt</h2>
            <p className="text-muted-foreground text-xl max-w-3xl mx-auto leading-loose">
