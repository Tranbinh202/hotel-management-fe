...
import { useOfflineBookings, useConfirmDeposit, useConfirmPayment, useCancelOfflineBooking, useResendEmail } from "@/lib/hooks/use-offline-bookings"
...
export default function AdminBookingsPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge variant="outline" className={`${colors[status] || "bg-slate-100 text-slate-700 border-slate-200"} font-medium`}>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50/30 p-6 space-y-6">
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          ...
          <p className="text-slate-500">
            Quản lý và theo dõi các booking offline của bạn.
          </p>
        </div>
        <Link href="/admin/bookings/new">
          <Button className="bg-[#8C68E6] hover:bg-[#7a5ad1] text-white shadow-lg shadow-purple-200 transition-all hover:shadow-xl hover:shadow-purple-300">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-10 h-11 border-slate-300 focus:border-[#8C68E6] focus:ring-[#8C68E6]/20"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 h-11 w-[160px] border-slate-300 focus:border-[#8C68E6]"
                  placeholder="Từ ngày"
                />
              </div>
            ...
            <Sheet open={filterSidebarOpen} onOpenChange={setFilterSidebarOpen}>
              <SheetTrigger asChild>
                <Button variant="outline" className="h-11 border-[#8C68E6] text-[#8C68E6] hover:bg-purple-50">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <SheetContent className="w-full  sm:max-w-md flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto py-6 px-4 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setAdvancedFilters({ ...advancedFilters, paymentStatus: value === "all" ? "" : value })}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setAdvancedFilters({ ...advancedFilters, depositStatus: value === "all" ? "" : value })}
                    >
                      <SelectTrigger className="w-full border-slate-300">
                        <SelectValue placeholder="Chọn trạng thái" />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setAdvancedFilters({ ...advancedFilters, roomType: value === "all" ? "" : value })}
                    >
                      <SelectTrigger className="w-full border-slate-300">
                ...
                <div className="border-t py-4 px-4 flex gap-3">
                  ...
                  <Button 
                    className="flex-1 h-11 bg-[#8C68E6] hover:bg-[#7a5ad1]"
            ...
            <Button 
              ...
              className="h-11 w-11 text-slate-500 hover:text-slate-700 hover:bg-slate-100"
      ...
      <Card className="shadow-lg border-slate-200">
        <CardHeader className="border-b border-slate-100">
          <CardTitle className="text-xl font-semibold text-slate-800">Danh sách booking</CardTitle>
        </CardHeader>
        <CardContent className="p-6">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20">
              <div className="w-16 h-16 border-4 border-[#8C68E6] border-t-transparent rounded-full animate-spin mb-4"></div>
            ...
            <div className="flex flex-col items-center justify-center py-20 px-4">
              ...
              <h3 className="text-xl font-semibold text-slate-700 mb-2">
                Chưa có đặt phòng nào được tìm thấy.
              </h3>
              <p className="text-slate-500 text-center mb-6 max-w-md">
                Hãy thử tìm kiếm với các tiêu chí khác hoặc tạo một đặt phòng mới để bắt đầu.
              </p>
              <Link href="/admin/bookings/new">
                <Button variant="outline" className="border-[#8C68E6] text-[#8C68E6] hover:bg-purple-50">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
                  Tạo booking mới
            ...
            <div className="space-y-4">
              {bookingsData?.data?.items?.map((booking: any) => (
                <div
                  ...
                  className="group flex items-center justify-between p-5 bg-white rounded-xl border border-slate-200 hover:border-[#8C68E6]/50 hover:shadow-lg transition-all duration-200"
                >
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="font-bold text-slate-900 text-lg">#{booking.bookingId}</span>
                      <span className="font-semibold text-slate-800">{booking.customerName}</span>
                      {getStatusBadge(booking.paymentStatus)}
                      {getStatusBadge(booking.depositStatus)}
                      <Badge variant="outline" className="bg-purple-50 text-purple-700 border-purple-200">{booking.bookingType}</Badge>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right pr-4 border-r border-slate-200">
                      <div className="font-bold text-slate-900 text-lg">{booking.totalAmount.toLocaleString("vi-VN")}đ</div>
                      <div className="text-sm text-slate-500">Cọc: {booking.depositAmount.toLocaleString("vi-VN")}đ</div>
                    </div>
                    <div className="flex flex-col gap-2">
                      {booking.depositStatus === "Unpaid" && (
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setDepositData({ depositAmount: 0, paymentMethod: "Cash", paymentNote: "", transactionReference: "" })
                      ...
                      {booking.paymentStatus === "Unpaid" && (
                        <Button
                          ...
                          onClick={() => {
                            setSelectedBooking(booking)
                            setPaymentData({ paidAmount: 0, paymentMethod: "Cash", paymentNote: "", transactionReference: "" })
          ...
          {bookingsData?.data && bookingsData.data.totalPages > 1 && (
            <div className="flex items-center justify-between mt-8 pt-6 border-t border-slate-200">
              <p className="text-sm text-slate-600">
                Hiển thị {(pageNumber - 1) * pageSize + 1} - {Math.min(pageNumber * pageSize, bookingsData.data.totalCount)} trong tổng số {bookingsData.data.totalCount} booking
              </p>
                  ...
                  {Array.from({ length: Math.min(5, bookingsData.data.totalPages) }, (_, i) => {
                    ...
                    return (
                      <Button
                        ...
                        className={pageNum === pageNumber ? "bg-[#8C68E6] hover:bg-[#7a5ad1] border-[#8C68E6]" : "border-slate-300"}
                      >
                        {pageNum}
                      </Button>
                    )
      ...
      <Dialog open={depositDialog} onOpenChange={setDepositDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleConfirmDeposit} disabled={confirmDeposit.isPending} className="bg-[#8C68E6] hover:bg-[#7a5ad1]">
      ...
      <Dialog open={paymentDialog} onOpenChange={setPaymentDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleConfirmPayment} disabled={confirmPayment.isPending} className="bg-[#8C68E6] hover:bg-[#7a5ad1]">
