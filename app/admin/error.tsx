  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[oklch(0.25_0.04_265)] to-[oklch(0.30_0.04_265)] p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Lỗi hệ thống quản trị</h1>
        <p className="text-gray-600 mb-6">
          Đã xảy ra lỗi trong quá trình xử lý. Vui lòng thử lại hoặc liên hệ IT support.
        </p>
        {error.message && (
